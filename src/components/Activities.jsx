...
<section class="services-section">
  ...
  <div class="service-card card-pink">
            <div class="front">
                ...
                <p class="service-desc">Discover the joy of reading and explore a wide variety of books.</p>
            </div>
            <div class="back">
        ...
        <div class="service-card card-purple">
            <div class="front">
                ...
                <p class="service-desc">Celebrate special moments with friends and family.</p>
            </div>
            <div class="back">
        ...
        <div class="service-card card-yellow">
            <div class="front">
                ...
                <p class="service-desc">Celebrate in style with a perfect blend of ambiance, music, and culinary delights.</p>
        ...
        <div class="service-card card-blue">
            <div class="front">
                ...
                <h4 class="service-title">Cafe</h4>
                 <p class="service-desc">Relax, sip your favorite coffee, and enjoy the cozy ambiance.</p>
        ...
        <div class="service-card card-green">
            <div class="front">
                ...
                <p class="service-desc">Discover fresh produce, household essentials, and great deals at your convenience.</p>
        ...
        <div class="service-card card-pink">
            <div class="front">
                ...
                <p class="service-desc">Pamper yourself with our expert beauty and grooming services.</p>
            </div>
        ...
        <div class="service-card card-purple">
            <div class="front">
                ...
                <p class="service-desc">Receive top-quality medical care from our expert healthcare professionals.</p>
            </div>
        ...
        <div class="service-card card-yellow">
            <div class="front">
                ...
                <p class="service-desc">Dedicated to protecting lives and property with quick and professional emergency services.</p>
            </div>
        ...
        <div class="service-card card-blue">
            <div class="front">
                ...
                <p class="service-desc">Enjoy homemade meals, heartwarming stories, and cozy moments with grandma.</p>
            </div>
        ...
        <div class="service-card card-green">
            <div class="front">
                ...
                <p class="service-desc">Explore the grandeur and history of our majestic castle with guided tours.</p>
            </div>
        ...
        <div class="service-card card-pink">
            <div class="front">
                ...
                <p class="service-desc">Explore the world of science through hands-on experiments and cutting-edge research.</p>
            </div>
        ...
        <div class="service-card card-purple">
            <div class="front">
                ...
                <p class="service-desc">Engage in an exciting game of chess with oversized pieces and challenging strategies.</p>
            </div>
        ...
        <div class="service-card card-yellow">
            <div class="front">
                ...
                <p class="service-desc">Refuel your vehicle with high-quality fuel and enjoy convenient services.</p>
            </div>
        ...
        <div class="service-card card-blue">
            <div class="front">
                ...
                <p class="service-desc">Stay fit and healthy by engaging in various exercise routines and workouts.</p>
            </div>
        ...
        <div class="service-card card-green">
            <div class="front">
                ...
                <p class="service-desc">Experience thrilling performances and showcase your talent on the stage.</p>
            </div>
        ...
        <div class="service-card card-pink">
            <div class="front">
                ...
                <p class="service-desc">Explore a wide variety of music instruments and unleash your musical creativity.</p>
            </div>
        ...
        <div class="service-card card-purple">
            <div class="front">
                ...
                <p class="service-desc">Express your creativity through drawing and painting in our art workshops.</p>
            </div>
        ...
        <div class="service-card card-yellow">
            <div class="front">
                ...
                <p class="service-desc">Learn essential road safety rules and ensure your safety on the road.</p>
            </div>
        ...
        <div class="service-card card-blue">
            <div class="front">
                ...
                <p class="service-desc">Send and receive letters, parcels, and enjoy postal services at your convenience.</p>
            </div>
        ...
        <div class="service-card card-green">
            <div class="front">
                ...
                <p class="service-desc">Explore the world, learn about different cultures, and expand your global knowledge.</p>
            </div>
